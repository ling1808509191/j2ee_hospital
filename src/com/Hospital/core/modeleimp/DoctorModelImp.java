...
public class DoctorModelImp implements doctorModel {
	...
	public boolean addPlan(int d_id, String date, List<Integer> time, List<Byte> p_num) {
		...
		for(int i = 0; i < time.size(); i++) {
			switch(time.get(i)) {
			case 1: p.setTime_1(p_num.get(i)); break;
			case 2: p.setTime_2(p_num.get(i)); break;
			case 3: p.setTime_3(p_num.get(i)); break;
			case 4: p.setTime_4(p_num.get(i)); break;
			case 5: p.setTime_5(p_num.get(i)); break;
			case 6: p.setTime_6(p_num.get(i)); break;
			case 7: p.setTime_7(p_num.get(i)); break;
			case 8: p.setTime_8(p_num.get(i)); break;
			case 9: p.setTime_9(p_num.get(i)); break;
			case 10: p.setTime_10(p_num.get(i)); break;
			case 11: p.setTime_11(p_num.get(i)); break;
			case 12: p.setTime_12(p_num.get(i)); break;
			case 13: p.setTime_13(p_num.get(i)); break;
			case 14: p.setTime_14(p_num.get(i)); break;
			case 15: p.setTime_15(p_num.get(i)); break;
			default: p.setTime_16(p_num.get(i)); break;
			}
